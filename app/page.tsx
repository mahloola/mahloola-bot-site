...
export default function Home() {
  return (
    <>
      ...
      {/* SVG WAVES */}
      <svg className="bg-transparent absolute bottom-0 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgb(24 24 27)" fillOpacity="1" d="M0,64L48,101.3C96,139,192,213,288,234.7C384,256,480,224,576,229.3C672,235,768,277,864,298.7C960,320,1056,320,1152,314.7C1248,309,1344,299,1392,293.3L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
      <svg className="bg-transparent absolute pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgb(24 24 27)" fillOpacity="1" d="M0,96L48,80C96,64,192,32,288,26.7C384,21,480,43,576,58.7C672,75,768,85,864,106.7C960,128,1056,160,1152,149.3C1248,139,1344,85,1392,58.7L1440,32L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
      ...
      {/* SVG WAVES 2 */}
      <svg className="bg-transparent absolute pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgb(24 24 27)" fillOpacity="1" d="M0,32L80,26.7C160,21,320,11,480,26.7C640,43,800,85,960,90.7C1120,96,1280,64,1360,48L1440,32L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
      <ShoppingCart/>
    </>
  );
}
